 ...
 */
final class Version20220305210539 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT NOT NULL, gym_id INT NOT NULL, title VARCHAR(128) NOT NULL, description TEXT DEFAULT NULL, event_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, length INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_3BAE0AA7BD2F03 ON event (gym_id)');
        ...
        $this->addSql('ALTER TABLE event ADD CONSTRAINT FK_3BAE0AA7BD2F03 FOREIGN KEY (gym_id) REFERENCES "public"."Gym" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE event_user ADD CONSTRAINT FK_92589AE2A76ED395 FOREIGN KEY (user_id) REFERENCES "public"."user" (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
