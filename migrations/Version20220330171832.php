 ...
 */
final class Version20220330171832 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE payments (id INT NOT NULL, franchise_id INT NOT NULL, type VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, amount INT NOT NULL, status VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
