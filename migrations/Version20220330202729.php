 ...
 */
final class Version20220330202729 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_route (user_id INT NOT NULL, route_id INT NOT NULL, PRIMARY KEY(user_id, route_id))');
        $this->addSql('CREATE INDEX IDX_E006DB21A76ED395 ON user_route (user_id)');
        $this->addSql('CREATE INDEX IDX_E006DB2134ECB4E6 ON user_route (route_id)');
        ...
        $this->addSql('ALTER TABLE user_route ADD CONSTRAINT FK_E006DB21A76ED395 FOREIGN KEY (user_id) REFERENCES "public"."user" (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE user_route ADD CONSTRAINT FK_E006DB2134ECB4E6 FOREIGN KEY (route_id) REFERENCES route (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
