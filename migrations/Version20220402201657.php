...
final class Version20220402201657 extends AbstractMigration {
    ...
    public function up(Schema $schema): void {
        ...
        $this->addSql('CREATE SEQUENCE route_user_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE payments (id INT NOT NULL, franchise_id INT NOT NULL, type VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, amount INT NOT NULL, status VARCHAR(255) NOT NULL, token VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_65D29B32523CAB89 ON payments (franchise_id)');
        $this->addSql('CREATE TABLE route_user (id INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE payments ADD CONSTRAINT FK_65D29B32523CAB89 FOREIGN KEY (franchise_id) REFERENCES "public"."Franchise" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void {
        ...
        $this->addSql('DROP SEQUENCE route_user_id_seq CASCADE');
