 ...
 */
final class Version20220625133622 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_B6BD307FE23BACF9 ON message (route_id_id)');
        ...
        $this->addSql('ALTER TABLE message ADD CONSTRAINT FK_B6BD307F9D86650F FOREIGN KEY (user_id_id) REFERENCES "public"."user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE message ADD CONSTRAINT FK_B6BD307FE23BACF9 FOREIGN KEY (route_id_id) REFERENCES route (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
