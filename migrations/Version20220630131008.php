 ...
 */
final class Version20220630131008 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "public"."Gym" (id INT NOT NULL, franchise_id INT DEFAULT NULL, admin_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, size BIGINT DEFAULT NULL, pc VARCHAR(255) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, picture VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE event ADD CONSTRAINT FK_3BAE0AA761220EA6 FOREIGN KEY (creator_id) REFERENCES "public"."user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "Gym" (id INT NOT NULL, franchise_id INT DEFAULT NULL, admin_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, size BIGINT DEFAULT NULL, pc VARCHAR(255) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, picture VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
