 ...
 */
final class Version20220713182635 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE route ADD closed_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE route DROP closed_at');
    }
}
