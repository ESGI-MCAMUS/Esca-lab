 ...
 */
final class Version20220713183616 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE favorite_gym DROP CONSTRAINT fk_775fc8efc3cb8c35');
        $this->addSql('ALTER TABLE payments DROP CONSTRAINT fk_65d29b32bd2f03');
        ...
        $this->addSql('ALTER TABLE favorite_gym DROP CONSTRAINT fk_775fc8ef9d86650f');
        ...
        $this->addSql('ALTER TABLE message DROP CONSTRAINT fk_8d99fec39d86650f');
        ...
        $this->addSql('CREATE SEQUENCE "public"."message_id_seq" INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE "public"."user_id_seq" INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE TABLE "public"."Franchise" (id INT NOT NULL, admin INT DEFAULT NULL, name VARCHAR(255) NOT NULL, picture VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE "public"."Gym" (id INT NOT NULL, franchise_id INT DEFAULT NULL, admin_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, size BIGINT DEFAULT NULL, pc VARCHAR(255) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, picture VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE "public"."message" (id INT NOT NULL, user_id_id INT NOT NULL, route_id_id INT NOT NULL, message_content TEXT NOT NULL, date_created TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_8D99FEC39D86650F ON "public"."message" (user_id_id)');
        $this->addSql('CREATE INDEX IDX_8D99FEC3E23BACF9 ON "public"."message" (route_id_id)');
        ...
        $this->addSql('ALTER TABLE "public"."message" ADD CONSTRAINT FK_8D99FEC39D86650F FOREIGN KEY (user_id_id) REFERENCES "public"."user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE "public"."message" ADD CONSTRAINT FK_8D99FEC3E23BACF9 FOREIGN KEY (route_id_id) REFERENCES route (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE route ALTER closed_at TYPE TIMESTAMP(0) WITHOUT TIME ZONE');
        $this->addSql('ALTER TABLE route ALTER closed_at DROP DEFAULT');
        $this->addSql('COMMENT ON COLUMN route.closed_at IS NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE favorite_gym DROP CONSTRAINT FK_775FC8EF9D86650F');
        $this->addSql('ALTER TABLE media DROP CONSTRAINT FK_6A2CA10C9D86650F');
        $this->addSql('ALTER TABLE "public"."message" DROP CONSTRAINT FK_8D99FEC39D86650F');
        $this->addSql('ALTER TABLE reactions DROP CONSTRAINT FK_38737FB39D86650F');
        $this->addSql('ALTER TABLE user_user DROP CONSTRAINT FK_F7129A803AD8644E');
        $this->addSql('ALTER TABLE user_user DROP CONSTRAINT FK_F7129A80233D34C1');
        $this->addSql('ALTER TABLE user_route DROP CONSTRAINT FK_E006DB21A76ED395');
        $this->addSql('DROP SEQUENCE "public"."Gym_id_seq" CASCADE');
        $this->addSql('DROP SEQUENCE "public"."message_id_seq" CASCADE');
        ...
        $this->addSql('CREATE TABLE "Gym" (id INT NOT NULL, franchise_id INT DEFAULT NULL, admin_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, size BIGINT DEFAULT NULL, pc VARCHAR(255) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, picture VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE "Franchise" (id INT NOT NULL, admin INT DEFAULT NULL, name VARCHAR(255) NOT NULL, picture VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE message (id INT NOT NULL, user_id_id INT NOT NULL, route_id_id INT NOT NULL, message_content TEXT NOT NULL, date_created TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX idx_8d99fec3e23bacf9 ON message (route_id_id)');
        $this->addSql('CREATE INDEX idx_8d99fec39d86650f ON message (user_id_id)');
        ...
        $this->addSql('ALTER TABLE message ADD CONSTRAINT fk_8d99fec39d86650f FOREIGN KEY (user_id_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE message ADD CONSTRAINT fk_8d99fec3e23bacf9 FOREIGN KEY (route_id_id) REFERENCES route (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('DROP TABLE "public"."message"');
        $this->addSql('DROP TABLE "public"."user"');
        $this->addSql('ALTER TABLE route ALTER closed_at TYPE TIMESTAMP(0) WITHOUT TIME ZONE');
        $this->addSql('ALTER TABLE route ALTER closed_at DROP DEFAULT');
        $this->addSql('COMMENT ON COLUMN route.closed_at IS \'(DC2Type:datetime_immutable)\'');
    }
}
